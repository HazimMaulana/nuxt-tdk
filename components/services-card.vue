<template>
  <div class="flex flex-col rounded-4xl p-8 bg-white justify-center items-center space-y-4">
    ...
    <p class="font-extrabold text-black text-2xl">Lorem ipsum dolor sit.</p>
    <div class="flex flex-col w-full space-y-2">
      ...
      <p class="text-black">Lorem ipsum dolor sit amet.</p>
      <a href=""
        class="flex flex-row w-fit border-black border rounded-full px-4 py-2 mt-4 text-sm items-center space-x-2 hover:bg-gray-100 transition-colors">
        ...
        <p class="font-semibold text-black">Contact Us</p>
      </a>
    </div>
  </div>
</template>
