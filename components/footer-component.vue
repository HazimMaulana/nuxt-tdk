<template>
  <div class="h-lvh bg-[#EB5523] flex flex-col">
    <div class="flex flex-row w-full mt-24 justify-between">
      <div class="flex flex-col text-white pl-6">
        <a href="">Home</a>
        <a href="">Article</a>
        <a href="">Our Portofolio</a>
        <a href="">Our Service</a>
        <a href="">About Us</a>
      </div>
      <div class="flex flex-col w-[60%]">
        <p class="text-7xl font-bold text-white">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
        <a href="" class="flex flex-row items-center border-white border w-fit rounded-full px-4 py-1 space-x-2 mt-6 hover:bg-gray-400/50 hover:backdrop-blur-md ">
    ...
    <div class="flex w-full justify-center mt-8">
      <div class="flex flex-col ">
        <h1 class="text-7xl stroke font-extrabold">PT. TOTAL DESAIN</h1>
        <h1 class="text-7xl stroke font-extrabold">KONSULTAN</h1>
      </div>
    </div>
    <div class="flex flex-col mt-24 pl-6 text-white">
      <p>Privacy Policy</p>
