...
export default defineNuxtPlugin((nuxtApp) => {
  ...
  api.interceptors.request.use(
    (config) => {
      ...
      const accessToken = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY4ODhlZDlhNGRmZTQzOWE0Y2EzYjY3MyIsImlhdCI6MTc1NDUxMDgxMCwiZXhwIjoxNzU0NTExNzEwfQ.3dIIFTo75jQjSWy2DzQh8tEwSJ6lBkrIl3ZtPxuQjDQ"; // Ganti dengan cara Anda mendapatkan token akses
      if (accessToken) {
