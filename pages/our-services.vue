<template>
  <div class="bg-[url(/img/placeholder.png)] min-h-screen bg-cover bg-center flex flex-col md:pl-12 lg:pl-32">
    <div class="flex flex-col flex-grow w-full justify-center p-4">
      <div class="flex flex-col w-full md:w-1/2 justify-center items-center">
        <h1 class="font-bold text-xl md:text-5xl text-black">Lorem, ipsum dolor sit amet consectetur adipisicing elit.</h1>
      ...
      <a href="" class="flex flex-row w-fit border-black border rounded-full px-4 py-2 mt-6 text-sm items-center space-x-2 hover:bg-gray-100 transition-colors">
  ...
  <div class="max-w-screen min-h-screen flex flex-col justify-center lg:px-24 px-8 space-y-2 py-4 ">
    <div class="flex flex-col w-full">
      <p class="text-xl lg:text-3xl">Our Services</p>
      <h1 class="text-3xl lg:text-5xl font-bold text-[#EB5523]">Lorem Ipsum</h1>
    </div>
    <div class="grid lg:grid-cols-3 grid-cols-1 gap-4 lg:gap-16 w-full pt-8">
      <services-card />
      <services-card />
      <services-card />
    </div>
