<template>
  <div class="bg-[url(/img/placeholder.png)] min-h-screen bg-cover bg-center flex flex-col md:pl-12 lg:pl-32">
    <div class="flex flex-col flex-grow w-full justify-center py-4 px-12">
      <div class="flex flex-col w-full md:w-1/2 justify-center items-center">
        <h1 class="font-bold text-3xl md:text-5xl text-black">Lorem, ipsum dolor sit amet consectetur adipisicing elit.
        </h1>
