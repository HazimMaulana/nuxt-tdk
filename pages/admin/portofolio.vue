<template>
  <div class="flex flex-col min-h-screen bg-white py-4">
    ...
    <div v-if="tampilanAktif === 'daftar'" class="px-6 mt-12">
      <div class="flex flex-row justify-between items-center w-full">
        ...
        <div class="flex flex-row items-center space-x-3">
          <div class="flex flex-row border border-black rounded-4xl px-2 items-center">
            ...
            <input type="text" placeholder="search" class="p-2 mr-3 border-0 bg-white text-black w-[400px]" style="outline: none" />
          </div>
    ...
    <div v-else-if="tampilanAktif === 'buat'" class="px-6 mt-12">
...
const tampilanAktif = ref("daftar");
const editorValue = ref("");

const judulHalaman = computed(() => {
  if (tampilanAktif.value === "buat") {
