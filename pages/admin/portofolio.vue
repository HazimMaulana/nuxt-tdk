  ...
  <div class="flex flex-col min-h-screen bg-white py-4">
    ...
    <div v-if="tampilanAktif === 'daftar'" class="px-6 mt-12">
      ...
      <div class="grid grid-cols-4 gap-12 w-full pt-6">
         <PortoCardAdmin v-for="portfolio in portfoliosList" :key="portfolio.id"
...
<script>
// [CLEANUP] Menghapus import yang tidak perlu. Editor dan PortoCardAdmin sudah di-auto-import oleh Nuxt.
// FormData adalah API bawaan browser, tidak perlu di-import.
