<template>
  <div
    class="bg-[url(/img/placeholder.png)] h-[50vh] lg:h-screen bg-cover bg-center flex flex-col justify-center text-black items-center">
    <div class="space-y-2 lg:w-1/2 flex flex-col items-center">
      <h1 class="font-extrabold text-2xl lg:text-5xl text-center">Lorem ipsum dolor sit amet consectetur adipisicing
        elit.</h1>
      <p class="lg:text-2xl text-center">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Accusamus ab magni
        explicabo quibusdam architecto tenetur?</p>
      <a href=""
        class="flex flex-row w-fit border-black border rounded-full px-4 py-2 mt-6 text-sm items-center space-x-2 hover:bg-gray-100 transition-colors">
        ...
        <p class="font-semibold text-black">Our Services</p>
      </a>
    </div>
  </div>
  ...
  <div class="max-w-screen min-h-screen flex flex-col justify-center items-center px-8 md:px-32 py-16 bg-slate-300">
    <div class="flex flex-col w-full">
      <p>Our Article</p>
      <h1 class="text-3xl font bold text-[#EB5523]">Lorem Ipsum</h1>
    </div>
    <div class="flex flex-col lg:flex-row w-full mt-5 justify-center items-center">
      <div class="grid grid-cols-1 lg:grid-cols-3 lg:gap-x-24 w-full">
        <homepage-card class="h-5/6" title="Card Title"
          shortDescription="A card component has a figure, a body part, and inside body there are title and actions parts." />
        <homepage-card class="h-5/6" title="Card Title"
          shortDescription="A card component has a figure, a body part, and inside body there are title and actions parts." />
        <homepage-card class="h-5/6" title="Card Title"
