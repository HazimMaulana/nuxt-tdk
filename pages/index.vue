<template>
  <div class="bg-[url(/img/placeholder.png)] min-h-screen bg-cover bg-center flex flex-col">
    <div class="flex flex-col flex-grow w-full justify-center items-center p-4 mt-[YOUR_NAVBAR_HEIGHT]">
      ...
      <a href=""
        class="flex flex-row border-black border rounded-full px-4 py-2 mt-6 text-sm items-center space-x-2 hover:bg-gray-100 transition-colors">
        ...
        <p class="font-semibold text-black">More Of Our Team</p>
      </a>
    </div>
  </div>
      ...
      <div class="flex flex-col w-full items-start">
        ...
        <div class="flex w-full items-end justify-end">
          <a href="" class="flex flex-row text-black items-center mt-4 sm:mt-0 hover:text-opacity-75">
            ...
            <svg width="32" height="18" viewBox="0 0 44 25" fill="none" xmlns="http://www.w3.org/2000/svg"
