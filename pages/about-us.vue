<template>
  <div class="relative h-[50vh] lg:h-screen flex flex-col justify-center items-center">
    ...
    <div class="relative space-y-2 lg:w-1/2 flex flex-col items-center p-4">
      ...
      <a href="" class="group flex flex-row w-fit border-white border rounded-full px-4 py-2 mt-6 text-sm items-center space-x-2 hover:bg-white transition-colors">
  ...
  <div class="flex flex-col max-w-screen min-h-screen bg-gray-200 justify-center items-center py-6">
    ...
    <div class="flex flex-row w-180 h-fit pt-6">
      ...
      <div class="flex flex-col bg-white h-auto w-full my-4 shadow-lg shadow-gray-400 py-6 px-8 justify-center space-y-4 rounded-r-lg">
        <h1 class="text-black font-bold text-2xl">Johnny Stings</h1>
        <h2 class="text-black font-semibold text-lg">Director</h2>
    ...
    <div class="grid grid-cols-2 items-center gap-12 mt-12">
      <div class="flex flex-row w-140 bg-slate-800 justify-center items-center px-4 h-72 shadow-xl shadow-gray-400 rounded-xl">
