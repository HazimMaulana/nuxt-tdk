<template>
  <div class="bg-[url(/img/placeholder.png)] h-[50vh] lg:h-screen bg-cover bg-center flex flex-col justify-center text-black">
    <div class="w-9/10 pl-12 space-y-2 lg:pl-24 lg:w-1/2">
      ...
      <p class="lg:text-2xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Accusamus ab magni explicabo quibusdam architecto tenetur?</p>
