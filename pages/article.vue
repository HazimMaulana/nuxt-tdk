<template>
  <div
    class="bg-[url(/img/placeholder.png)] h-[50vh] lg:h-screen bg-cover bg-center flex flex-col justify-center text-black">
    <div class="w-9/10 pl-12 space-y-2 lg:pl-24 lg:w-1/2">
      <h1 class="font-extrabold text-2xl lg:text-5xl">Lorem ipsum dolor sit amet consectetur adipisicing elit.</h1>
      <p class="lg:text-2xl">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Accusamus ab magni explicabo
        quibusdam architecto tenetur?</p>
      <a href=""
  ...
  <div class="max-w-screen min-h-screen flex flex-col justify-center items-center px-8 md:px-32 py-16">
    ...
    <div class="grid grid-cols-2 md:grid-cols-4 gap-2 md:gap-14 md:mt-8">
      <article-card title="Lorem ipsum dolor sit amet consectetur adipisicing elit." author="Jhon Doe" />
      <article-card title="Lorem ipsum dolor sit amet consectetur adipisicing elit." author="Jhon Doe" />
      <article-card title="Lorem ipsum dolor sit amet consectetur adipisicing elit." author="Jhon Doe" />
      <article-card title="Lorem ipsum dolor sit amet consectetur adipisicing elit." author="Jhon Doe" />
      <article-card title="Lorem ipsum dolor sit amet consectetur adipisicing elit." author="Jhon Doe" />
